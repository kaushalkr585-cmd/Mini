  ...
  return (
    <motion.div
      ...
      className={`group relative flex cursor-pointer items-center gap-3 rounded-xl px-3 py-2.5 transition-all ${
        isCurrent
          ? "bg-primary/20 border border-primary/40 shadow-[0_0_20px_oklch(0.72_0.28_350/0.15)] text-foreground font-semibold"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            {!token && (
              <a
                ...
                className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-[#1DB954] px-6 py-3 text-sm font-bold text-white shadow-[0_0_20px_#1DB95450] hover:scale-105 transition-transform whitespace-nowrap"
              >
        ...
        >
          ...
          <input
            ...
            disabled={!token}
            className="w-full rounded-2xl glass-strong py-4 pl-12 pr-28 text-base text-foreground font-medium outline-none ring-0 focus:ring-2 focus:ring-primary/40 placeholder:text-muted-foreground disabled:opacity-50"
          />
          <button
            type="submit"
